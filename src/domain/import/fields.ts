...
export const FIELD_SPECS: Record<ImportKind, FieldSpec[]> = {
  ...
  AVAILABILITY: [
    ...
    {
      key: 'team',
      label: 'NBA team(s) that season',
      required: false,
      synonyms: ['team(s)', 'teams', 'team', 'tm', 'nba team'],
      help: 'Several teams (trade) separated by "/" or ","; used only to disambiguate identity',
    },
    { ...PID, synonyms: [...PID.synonyms, 'stable player id', 'source player id'] },
    { key: 'season', label: 'Season (YYYY-YY)', required: true, synonyms: ['season', 'year'] },
    { key: 'gamesPlayed', label: 'Games played', required: true, synonyms: ['gp', 'games played', 'games'] },
    {
      key: 'gamesAvailable',
      label: 'Games available',
      required: false,
      synonyms: ['games available', 'gamesavailable', 'available games'],
      help: 'Games the player could have played (after joining the league, across all teams). Defaults to Team Games with a warning.',
    },
    {
      key: 'teamGames',
      label: 'Team games (season length)',
      required: false,
    ...
    {
      key: 'suspensionGames',
      label: 'Suspension games (not injury)',
      required: false,
      synonyms: ['suspension games', 'suspension', 'suspended games'],
    },
    {
      key: 'otherNonInjuryGames',
      label: 'Other non-injury games',
      required: false,
      synonyms: ['other non-injury games', 'other non injury games', 'non-injury games', 'other games'],
    },
    {
      key: 'note',
      label: 'Status note',
      required: false,
      synonyms: ['status note', 'note', 'notes', 'reason'],
    },
    ...PROVENANCE,
  ],
  CONTEXT: [
