...
| -------------------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Projections (per provider) | name, GP, 3PM, PTS, REB, AST, STL, BLK, TO, **FGA and FTA** (or pct cells with makes/attempts) | team, positions, provider id, MPG, FGM, FG%, FTM, FT%, basis (`PER_GAME`/`TOTAL`), upside (0–1)                                                                                                  | Hashtag-style `0.483 (7.1/14.7)` cells are parsed into pct, makes and attempts. Percentages without attempts are **rejected** (volume is required). If both makes and pct are given and differ by more than 0.5 pp, a warning is raised and makes/attempts are used. `TOTAL` stats are divided by GP. |
| Yahoo market               | name                                                                                           | team, positions, Yahoo id, **XRank**, **Rank**, **Last 7 Days ADP**, status                                                                                                                      | The three market fields are stored separately and never combined. Yahoo positions become authoritative eligibility. Status markers (`INJ`, `GTD`, `O`, `IL`, `NA`, `SUSP`, …) are mapped.                                                                                                             |
| Availability history       | name, season, GP                                                                               | team games (default 82), missed LOW / MODERATE / HIGH / UNCLASSIFIED, note                                                                                                                       | One row per player-season. The recurrence class is yours to assign; the app never infers diagnoses.                                                                                                                                                                                                   |
